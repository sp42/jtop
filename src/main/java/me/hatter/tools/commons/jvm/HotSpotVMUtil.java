...
import com.ajaxjs.jtop.util.ClassLoaderUtil;
import me.hatter.tools.commons.environment.Environment;
import me.hatter.tools.commons.environment.Environment.JavaVendor;
import me.hatter.tools.commons.object.LogUtil;
import me.hatter.tools.commons.object.OSUtil;
import me.hatter.tools.commons.object.OSUtil.OS;
...
public class HotSpotVMUtil {
    ...
    public static enum JDKLib {
        ...
        TOOLS("tools.jar", //
                Arrays.asList(JavaVendor.Sun, JavaVendor.Oracle, JavaVendor.Unknown), //
                Arrays.asList(OS.Linux, OS.Unix, OS.MacOS)),

        // Use for load agent
        MANAGEMENT_AGENT("management-agent.jar", //
                Arrays.asList(JavaVendor.Apple, JavaVendor.Sun, JavaVendor.Oracle, JavaVendor.Unknown), //
